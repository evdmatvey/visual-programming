...
import styles from './BooksSort.module.css';
...
export const BooksSort = () => {
  ...
  const { sortBy, sortType, setSortBy, setSortType } = useBooksContext();
  const [isOpen, setIsOpen] = useState(false);
  const ref = useRef(null);

  useOutsideClick(ref, () => setIsOpen(false));

  const getSortByHeading = (sortBy) => (sortBy === 'title' ? 'Название' : 'Автор');
